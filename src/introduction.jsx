        ...
        <>
            <section className='mx-8 my-12 md:mx-16 md:mt-12 md:flex flex-row-reverse gap-12 justify-between lg:max-w-[1280px] lg:mx-auto lg:px-16'>
                <div className='basis-0 flex-grow z-[1]'>
                    <img src={illustrationIntro} alt="" className='z-[1] relative'/>
                </div>
                <div className='basis-0 flex-grow mt-8 md:mt-0 md:block text-center md:text-left z-[1]'>
                    ...
                    <button className='mt-8 px-8 py-4 text-white bg-bright-red rounded-[100vw] shadow-[0_5px_20px_#F25F3A]'>Get Started</button>
                </div>
            </section>

            <section className='mx-8 my-12 md:mx-16 md:mt-16 md:flex flex-wrap gap-12 lg:max-w-[1280px] lg:mx-auto lg:px-16'>
                ...
                <div className='basis-0 flex-grow mt-12 md:mt-0'>
                    <li className='mb-8 grid grid-cols-[min-content_1fr] gap-4 items-center relative'>
                    ...
                    <li className='mb-8 grid grid-cols-[min-content_1fr] gap-4 items-center'>
