    ...
    return (
        <footer className='py-20 md:py-16 bg-dark-blue-700 h-auto'>
            <div className='px-8 md:px-12 flex flex-col-reverse gap-12 items-center md:flex-row md:flex-wrap md:items-start md:justify-between md:gap-8 lg:max-w-[1280px] lg:mx-auto'>
                <div className='basis-0 flex-grow flex flex-col gap-12 md:flex-col-reverse items-center md:items-start'>
                    ...
                    <img src={logo} className='text-white w-[200px]' />
                </div>
                <div className='basis-0 flex-grow flex justify-evenly text-white gap-24 md:gap-12'>
                ...
                <div className='basis-0 flex-grow flex gap-4 items-center mx-8 md:mx-0 w-[350px] md:mr-16 md:w-auto flex-shrink'>
